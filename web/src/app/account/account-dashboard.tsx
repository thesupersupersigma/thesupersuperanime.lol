          ...
          <div style={{
            ...
            {TABS.map(tab => (
              <button
                ...
                onMouseEnter={e => { if (activeTab !== tab.id) e.currentTarget.style.color = "#a3a3a3" }}
                    ...
                    return (
                      ...
                      >
                        ...
                        <div style={{ textAlign: "right", flexShrink: 0 }}>
                          <div style={{ color: "#3b82f6", fontSize: "12px", fontWeight: 600, marginBottom: "2px" }}>
                            {formatProgress(entry.progress, entry.duration)}
                          </div>
                      ...
                      return (
                        <div key={status} style={{ marginBottom: "24px" }}>
                          <div style={{
                            ...
                            <span style={{ color: "#a3a3a3", fontSize: "12px", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.06em" }}>
                              {status} ({group.length})
                            </span>
                          </div>
            ...
            {activeTab === "import" && (
              <div style={{ maxWidth: "480px" }}>
                <h3 style={{
                  ...
                  fontWeight: 600, color: "#e5e5e5", marginBottom: "8px",
                }}>
                  Import from another site
                </h3>
                <p style={{ color: "#555", fontSize: "13px", lineHeight: "1.6", marginBottom: "20px" }}>
                  Upload an export file from AniKai or HiAnime to restore your watchlist and history. Supports .json, .txt, and .xml formats.
                </p>
                <ImportButton />
              </div>
            )}
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "20px", maxWidth: "480px" }}>
                <div>
                  ...
                  <p style={{ color: "#555", fontSize: "13px", marginBottom: "16px" }}>
                    Signed in as <span style={{ color: "#a3a3a3" }}>{user.email}</span>
                  </p>
                  <SignOutButton action={logOutAction} />
                </div>
                ...
                <div>
                  ...
                  <p style={{ color: "#555", fontSize: "13px", marginBottom: "16px" }}>
                    To change your password, sign out and use the "Forgot password?" link on the login screen.
                  </p>
                </div>
              </div>
            )}
