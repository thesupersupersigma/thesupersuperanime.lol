...
| `prisma/schema.prisma` | DB schema (User, WatchHistory, Watchlist, Comment, CommentLike, SourceToken, ProviderStatus, ProviderLog, Issue, GenreVote, Announcement, WatchStreak, Follow, WatchParty, Badge/UserBadge/GenreCache/AiringWatch, Season/SeasonResult, ChatMessage/ChatTimeout/ChatChannel) |
